	...
	return (
		<form className='space-y-6' onSubmit={onSubmit}>
			...
			<div className='pt-8'>
				<button
					type='submit'
					className='flex w-full justify-center rounded-xl bg-primary px-3 py-1.5 text-sm text-negative-color leading-6 font-[700] shadow-sm hover:bg-primary-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary'
					disabled={isLoading}
				>
